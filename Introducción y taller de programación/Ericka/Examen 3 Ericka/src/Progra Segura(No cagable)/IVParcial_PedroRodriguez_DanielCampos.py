...
#---------------------------------------------------------------
simula=input("Bienvienido. Digitar 1 por si desea una simulación automatica o 2 para manual... ")
if simula==1:
    cantidadpadron=random.randint(50,200)
else:
    cantidadpadron=input("Favor insertar el numero de estudiantes total para crear el padron estudiantil: ")
i=1
print ("====================================================================")
...
if simula==1:
    ...
    seguir=False
    while not seguir:
        cond=input("1. Ver situación de urnas\n2. Seguir votaciones\n")
        if cond==1:
